...
<aside class="w-64 bg-white border-r border-slate-200 flex flex-col z-20 fixed md:static inset-y-0 left-0 md:inset-auto transition-transform duration-300 ease-in-out" 
    ...
    <div class="h-16 flex items-center px-6 border-b border-slate-200">
        ...
        <svg 
            x-show="!systemLogo.path"
            class="w-8 h-8 text-indigo-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
        <span class="text-xl font-bold text-slate-800" x-text="systemLogo.name || 'LibSys'"></span>
    </div>
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <a href="#" @click.prevent="activeTab = 'settings'; sidebarOpen = false" :class="activeTab === 'settings' ? 'text-indigo-700 bg-indigo-50' : 'text-slate-600 hover:text-slate-800 hover:bg-slate-100'" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-colors">
    ...
    <div class="p-4 border-t border-slate-200">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-sm font-medium text-slate-800" x-text="currentUser.name"></p>
